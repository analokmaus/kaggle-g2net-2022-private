...
OUT = 'input/g2net-detecting-continuous-gravitational-waves/leak_1.pickle'
...
# denoised_target.to_csv('input/denoised_target.csv', index=False)
...
updated_target.to_csv('input/denoised_target_negative.csv', index=False)